...
\end{tabular}
\egroup
\caption[Comparison of the Top Phenotypes' Final States]{Here you see the comparison between the top phenotypes' final resting positions and orientations after moving forward per each experiment. The elapsed times indicate how long each top phenotype took before reaching its final at-rest state. The resulting genome fitnesses and the robust mean for the real robot forward motion are included for reference.}
