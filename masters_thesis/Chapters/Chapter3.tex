...
%and the parameters---of each genome---represent the 41 weights of the neural network. Each parameter has a valid range of $[-1,1]$. 
...
%\centering
    ...
    Fitness Function Type & \cellcolor{blue!25} Partial/Full & \cellcolor{blue!25} Full & Full & Full & Full & Full \\ \hline
    Number of Elite Offspring & 2  & 2 & 2 & 2 & 2 & 10  \\ \hline
    Roulette Selection - Actual Fitness & True & \cellcolor{blue!25} False  & False & False & False & N/A \\ \hline
    Roulette Selection - Rank Fitness & False & \cellcolor{blue!25} True & True & True & True & N/A \\ \hline
    Sequential Crossover \& Mutation & True & True & \cellcolor{blue!25} False & False & \cellcolor{blue!25} True & N/A \\ \hline
    %Parents Survive & True & True & \cellcolor{blue!25} False & False & False & N/A \\ \hline
    Self-adaptation & False & False & \cellcolor{blue!25} True & \cellcolor{blue!25} False & False &  N/A \\ \hline
    Crossover Type & One-point & One-point & One-point & One-point & One-point & N/A \\ \hline
    Crossover Probability & 0.7 & \cellcolor{blue!25} 0.8 & \cellcolor{blue!25} 0.5 & \cellcolor{blue!25} 0.7816 & 0.7816  & N/A \\ \hline
    Mutation Type & Uniform & \cellcolor{blue!25} Gaussian & Gaussian & Gaussian & Gaussian &  N/A \\ \hline
    Mutation Scope & Gene & Gene & \cellcolor{blue!25} Genome & Genome & \cellcolor{blue!25} Gene & N/A \\ \hline
    Mutation Probability & 0.1 & \cellcolor{blue!25} $\left(\frac{1}{n}\right)=\left(\frac{1}{41}\right) \approx 0.0244$ & \cellcolor{blue!25} 0.5 & \cellcolor{blue!25} 0.2184 & 0.2184 & N/A \\ \hline
    Mutation Step & $X\sim U(0,1) * 0.3$ & \cellcolor{blue!25} $X\sim N(\mu,\sigma^2)$ & $X\sim N(\mu,\sigma^2)$ & $X\sim N(\mu,\sigma^2)$ & $X\sim (\mu,\sigma^2)$ & N/A \\ \hline
    Mutation Step $\mu$ & N/A & \cellcolor{blue!25} Gene Value & Gene Value  & Gene Value  & Gene Value & N/A \\ \hline
    Mutation Step $\sigma$ & N/A & \cellcolor{blue!25} 0.5 & \cellcolor{blue!25} $M_{Prob.}$ & $M_{Prob.}$ & $M_{Prob.}$ & N/A \\ \hline
    \end{tabular}
...
% In other words, for example, if the crossover operator produced fitter genomes greater than the mutation operator did for the last generation, then the probability of creating offspring via crossover would be increased and the probability of creating offspring via mutation would be decreased for the creation of the next generation.
...
% Fitness Credit for not Staying in the Path of the Ball               & 0.0                                                      	\\ \hline
% \end{tabular}
% \caption[Experiment Six GA Parameters]{The genetic algorithm parameters for experiment six.}
% \label{tab:exp6}
% \end{table}
...
% \\ \hline
% \end{tabular}
% \caption[Experiment Seven GA Parameters]{The genetic algorithm parameters for experiment seven.}
% \label{tab:exp7}
% \end{table}
